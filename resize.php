...
{
	$width = ( $_GET['chapter'] != 'signimage' ) ? 363 : 363;  // 150 : 300; при таком разрешении не было рамки у изображения m201600073
...
if ($type == 2) $w = $width; // пропорциональная шириной $width 
...
if ($w_src > $w && $_GET['chapter'] != 'signimage') 
{
